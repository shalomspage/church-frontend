...
export default function Features() {
  const features = [
    {
      icon: '/images/sunday-service.jpg', // Path to your image
    ...
    {
      icon: '/images/freeindeed-service.jpg',
    ...
    {
      icon: '/images/deliverance-service.jpg',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-12 h-12 rounded-lg ${colorClasses[feature.color as keyof typeof colorClasses]} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform overflow-hidden`}>
                <Image 
                  src={feature.icon}
                  alt={feature.title}
                  width={48}
