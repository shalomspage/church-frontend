...
export default function Events() {
  ...
  useEffect(() => {
    const eventData = featuredEvents.map(event => ({
      id: event.id,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {upcomingEvents.length > 4 && (
          <div className="text-center">
            <Link 
              href="/events"
              className="inline-flex items-center border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-2 rounded-lg font-semibold text-lg transition-colors"
            >
